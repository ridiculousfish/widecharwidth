/*
 * widechar_width.h, generated on 2021-10-22.
 ...
 *  emoji-data.txt:      69c5842f2aa4db0b95838f438a4fe8f29f99939a
 */
...
const widechar_ascii_table = [
    [0x00020, 0x0007E]
];

/* Private usage range. */
const widechar_private_table = [
    [0x0E000, 0x0F8FF],
    [0xF0000, 0xFFFFD],
    [0x100000, 0x10FFFD]
];
...
const widechar_combining_table = [
    [0x00300, 0x0036F],
    [0x00483, 0x00489],
    [0x00591, 0x005BD],
    [0x005BF, 0x005BF],
...
/* Width.2 characters. */
const widechar_doublewide_table = [
    [0x01100, 0x0115F],
    [0x0231A, 0x0231B],
    [0x02329, 0x0232A],
    [0x023E9, 0x023EC],
...
const widechar_ambiguous_table = [
    [0x000A1, 0x000A1],
    [0x000A4, 0x000A4],
    [0x000A7, 0x000A8],
    [0x000AA, 0x000AA],
...
const widechar_unassigned_table = [
    [0x00378, 0x00379],
    [0x00380, 0x00383],
    [0x0038B, 0x0038B],
    [0x0038D, 0x0038D],
...
function widechar_in_table(data, ucs) {
    let min = 0;
